...
type PolicyDeployment struct {
	...
	Statements  []*gobgp.Statement        `protobuf:"bytes,3,rep,name=statements,proto3" json:"statements,omitempty"`
	Policies    []*gobgp.Policy           `protobuf:"bytes,4,rep,name=policies,proto3" json:"policies,omitempty"`
	Assignments []*gobgp.PolicyAssignment `protobuf:"bytes,5,rep,name=assignments,proto3" json:"assignments,omitempty"`
	PeerGroups  []*gobgp.PeerGroup        `protobuf:"bytes,6,rep,name=peer_groups,json=peerGroups,proto3" json:"peer_groups,omitempty"`
}
...
func (x *PolicyDeployment) GetStatements() []*gobgp.Statement {
	if x != nil {
		return x.Statements
	}
	return nil
...
var file_proto_policies_proto_rawDesc = []byte{
	...
	0x79, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x22, 0xb4, 0x02, 0x0a, 0x10, 0x50, 0x6f, 0x6c, 0x69, 0x63,
	...
	0x74, 0x73, 0x12, 0x30, 0x0a, 0x0a, 0x73, 0x74, 0x61, 0x74, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x73,
	0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x61, 0x70, 0x69, 0x70, 0x62, 0x2e, 0x53,
	0x74, 0x61, 0x74, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x0a, 0x73, 0x74, 0x61, 0x74, 0x65, 0x6d,
	0x65, 0x6e, 0x74, 0x73, 0x12, 0x29, 0x0a, 0x08, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x69, 0x65, 0x73,
	...
	0x39, 0x0a, 0x0b, 0x61, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x05,
	...
	0x73, 0x73, 0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x31, 0x0a, 0x0b, 0x70, 0x65,
	0x65, 0x72, 0x5f, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x10, 0x2e, 0x61, 0x70, 0x69, 0x70, 0x62, 0x2e, 0x50, 0x65, 0x65, 0x72, 0x47, 0x72, 0x6f, 0x75,
	0x70, 0x52, 0x0a, 0x70, 0x65, 0x65, 0x72, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x42, 0x10, 0x5a,
	0x0e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x69, 0x65, 0x73, 0x62,
...
var file_proto_policies_proto_goTypes = []interface{}{
	...
	(*gobgp.Statement)(nil),        // 3: apipb.Statement
	(*gobgp.Policy)(nil),           // 4: apipb.Policy
	(*gobgp.PolicyAssignment)(nil), // 5: apipb.PolicyAssignment
	(*gobgp.PeerGroup)(nil),        // 6: apipb.PeerGroup
}
var file_proto_policies_proto_depIdxs = []int32{
	...
	3, // 2: policies.PolicyDeployment.statements:type_name -> apipb.Statement
	4, // 3: policies.PolicyDeployment.policies:type_name -> apipb.Policy
	5, // 4: policies.PolicyDeployment.assignments:type_name -> apipb.PolicyAssignment
	6, // 5: policies.PolicyDeployment.peer_groups:type_name -> apipb.PeerGroup
